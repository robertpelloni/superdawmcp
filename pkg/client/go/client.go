...
func (c *Client) SetMixer(trackID string, volume float32, pan float32) error {
	...
	_, err := c.call("tools/call", args)
	return err
}

func (c *Client) WriteMIDI(trackID string, notes []daw.MIDINote) error {
	args := map[string]interface{}{
